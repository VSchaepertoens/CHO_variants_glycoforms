...
Download the folders containing raw data, intermediary files, and all figures from the following Zenodo link:[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.13880132.svg)](https://doi.org/10.5281/zenodo.15056920).Open Herceptin_November_2023.Rproj and run renv::restore() to install all necessary libraries. 
