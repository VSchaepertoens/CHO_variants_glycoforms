...
# samples_table <- read_csv("data/2_nglycans_quantification/2_2_pngaseF_cpb/overview_sample_pngase_merged.csv")
samples_table <- read_csv("data/3_lysine_glycation_quantification/overview_sample_pngase_lysine_merged.csv")
...
png(filename = "figures/3_lysine_glycation_quantification/lysine_hexosylation_heatmap.png",    
    height = 2000,
    width = 3000,
    units = "px",
    res = 300)
...
save(abundance_data,
     ...
     file = "analysis/3_lysine_glycation_quantification/pngase_output_tables/abundance_data_lysine_glucose.RData")
...
abundance_data_averaged %>%
  ...
  # labs(title = "C-terminal lysine and hexosylation") +
...
ggsave(filename = "figures/3_lysine_glycation_quantification/figure_11.png",    
       height = 8.89,
       width = 8.89,
       units = "cm",
       dpi = 600)
